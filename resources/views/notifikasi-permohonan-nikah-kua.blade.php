...
<body
    ...
    <div
        ...
        <p style="font-size: 16px; margin-bottom: 0.5rem;"><strong>👨 Mempelai Pria:</strong>
            {{ $permohonanNikah->mempelaiPria->nama_lengkap }}</p>
        <p style="font-size: 16px; margin-bottom: 0.5rem;"><strong>👰 Mempelai Wanita:</strong>
            {{ $permohonanNikah->mempelaiWanita->nama_lengkap }}</p>

        <p style="font-size: 16px; margin-bottom: 1rem;"><strong>📅 Tanggal Diverifikasi:</strong>
