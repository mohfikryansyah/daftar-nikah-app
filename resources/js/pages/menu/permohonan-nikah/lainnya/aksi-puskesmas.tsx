...
export default function AksiPermohonanNikahPuskesmas({ permohonanNikah, templateBerkas }: { permohonanNikah: PermohonanNikah, templateBerkas: TemplateBerkas[] }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        put(route('status-permohonan-nikah.update-puskesmas', { statusPermohonanNikah: permohonanNikah.latest_status.id }), {
            onSuccess: () => {
    ...
    return (
        <Card className="xl:max-h-fit w-full">
            <CardHeader>
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    <SelectItem value="Ditolak Puskesmas">Ditolak Puskesmas</SelectItem>
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                        <InputError message={errors.status_permohonan}></InputError>
                    </div>
                    {data.status_permohonan === 'Diverifikasi Puskesmas' && (
                        <>
                            <div className="grid gap-2">
                                <Label>
                                    Nomor Suket Bimbingan Kesehatan Keluarga
                                    <Required />
                                </Label>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select
                                    value={data.berkas_permohonan}
                                    onValueChange={(value) => setData('berkas_permohonan', value)}
                                    required
                                >
                                    <SelectTrigger className="w-full">
