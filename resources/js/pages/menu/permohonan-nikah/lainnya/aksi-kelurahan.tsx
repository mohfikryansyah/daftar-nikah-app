...
export default function AksiPermohonanNikahKelurahan({ permohonanNikah, templateBerkas }: { permohonanNikah: PermohonanNikah, templateBerkas: TemplateBerkas[] }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        put(route('status-permohonan-nikah.update', { statusPermohonanNikah: permohonanNikah.latest_status.id }), {
            onSuccess: () => {
                ...
                <form onSubmit={submit} className="space-y-4">
                    <div className="grid gap-2">
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    <SelectItem value="Menunggu Verifikasi Kelurahan">Menunggu Verifikasi Kelurahan</SelectItem>
