...
const isFinalStep = currentStep > totalSteps - 1;
  ...
  return (
    ...
    >
      <div
        className={`bg-white mx-auto w-full rounded-xl shadow-lg   ${stepCircleContainerClassName}`}
      >
        <div
          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                {...nextButtonProps}
              >
                {isFinalStep ? "Submit" : nextButtonText}
              </button>
            </div>
          </div>
        )}
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#F0F0F0", color: "#a3a3a3" },
          active: { scale: 1, backgroundColor: "#e05d38", color: "#e05d38" },
          complete: { scale: 1, backgroundColor: "#e05d38", color: "#3b82f6" },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#e05d38" },
  };
